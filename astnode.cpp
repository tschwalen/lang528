...
ASTNode ASTNode::makeLetDeclare (string name, ASTNode rhs,
                                 TokenMetadata metadata) {
  return ASTNode{
    NodeType::VAR_DECLARE, { rhs }, { "const", false }, metadata
  };
}

ASTNode ASTNode::makeConstDeclare (string name, ASTNode rhs,
                                   TokenMetadata metadata) {
  return ASTNode{
    NodeType::VAR_DECLARE, { rhs }, { "const", true }, metadata
  };
}

ASTNode ASTNode::makeBlock (vector<ASTNode> statements,
                            TokenMetadata metadata) {
...
ASTNode ASTNode::makeIfElse (ASTNode condition, ASTNode body,
...
ASTNode ASTNode::makeIndexAccess (ASTNode lvalue_expr, ASTNode index_expr,
                                  TokenMetadata metadata) {
  return ASTNode{
    NodeType::EXPR_LIST, { lvalue_expr, index_expr }, {}, metadata
  };
}
...
ASTNode ASTNode::makeBinaryOp (TokenType op, ASTNode lhs_expr,
  ...
  return ASTNode{ NodeType::BINARY_OP,
                  { lhs_expr, rhs_expr },
                  { { "op_name", token_type_to_string (op) },
                    { "op", (int)op } },
                  metadata };
}
...
ASTNode ASTNode::makeAssignOp (TokenType op, ASTNode lhs_expr,
                               ASTNode rhs_expr, TokenMetadata metadata) {
