...
string token_type_to_string(TokenType e) {
  vector<string> values{
      "FUNCTION",     "LET",           "CONST",         "IF",
      "ELSEIF",       "ELSE",          "WHILE",         "RETURN",
      "IDENTIFIER",   "DOT",           "DOT_DOT",       "COMMA",
      "EQUALS",       "EQUALS_EQUALS", "NOT",           "NOT_EQUALS",
      "LESS",         "LESS_EQUALS",   "GREATER",       "GREATER_EQUALS",
      "PLUS",         "PLUS_EQUALS",   "AND",           "OR",
      "MINUS",        "MINUS_EQUALS",  "TIMES",         "TIMES_EQUALS",
      "DIV",          "DIV_EQUALS",    "MOD",           "MOD_EQUALS",
      "LPAREN",       "RPAREN",        "LBRACKET",      "RBRACKET",
      "LBRACE",       "RBRACE",        "COLON",         "SEMICOLON",
      "BOOL_LITERAL", "INT_LITERAL",   "FLOAT_LITERAL", "STRING_LITERAL",
      "END_OF_FILE",  "NULL_TOKEN",
  };
...
TokenType int_to_token_type(int i) {
  vector<TokenType> values{
      ...
      TokenType::CONST,         TokenType::IF,
      TokenType::ELSEIF,        TokenType::ELSE,
      TokenType::WHILE,         TokenType::RETURN,
      TokenType::IDENTIFIER,    TokenType::DOT,
      TokenType::DOT_DOT,       TokenType::COMMA,
      ...
      TokenType::END_OF_FILE,   TokenType::NULL_TOKEN,
  };
  return values.at(i);
}
